...
export function Prologue(game) {
  ...
  game.tileData = [
    ...
    '                         1111111111111111111111111             8                                                                                                                     111111111111111    ',
    '                         1111111111111111111111111            88                                                                                                                     111111111111111    ',
    '                         1111111111111111111111111            88                                                                                                                     111111111111111    ',
    '                         111111111111111111111111             888                                                                                                                     11111111111111    ',
    '                         111111111111111111111111            8888                                                                                                                     11111111111111    ',
    '                         111111111111111111111111            88888                                                                                                                    11111111111111    ',
  ...
  game.gameObjects.push(
    ...
    new $.Interactable(1456, 320, 16, 16, 'prologue/not_finish', 'character/zhishiqie/normal', '芝士企鹅', false, async (game, $) => {
      if(game.levelData.collectOK)
      $('levelChanger').r.y = 300
    }).ref('qie2'),
    new $.LevelChanger(712, 400, 8, 16, '测试大厅', false).hide(),
    new $.LevelChanger(1416, 184, 48, 48, 'Stage2', true).ref('levelChanger').hide(),
    ...
    new $.Platform(1457, 312, 16, 24, false).hide(),
